...
def reference_stats(rows: List[dict]) -> List[dict]:
    ...
    over ruim 4 km deels écht microklimaat, maar de spreiding is de ruisvloer waar
...
def main() -> None:
    ...
    # Tweede referentie (KNMI De Bilt, ruim 4 km) — niet-fataal: de diagnose blijft
...
if __name__ == "__main__":
    # Maandelijkse cron die niemand ziet draaien: zonder guard veroudert
    # SOLAR_BIAS_SLOPE stilzwijgend bij een crash (zelfde klasse als de
    # 0.00421-les hierboven). Elke andere runner draagt deze wrapper al.
    run_guarded(main, "station-accuracy")
