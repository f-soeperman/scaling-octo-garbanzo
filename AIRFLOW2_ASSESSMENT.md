...
| parameter | runs |
|---|---|
| `nursery.ua_env`, `nursery.ua_party`, `bedroom.ua_party`, `office.f_air`, `bath.ua_env` | 10/10 |
| `living.f_air` | 9/10 |
| `nursery.f_air` | 8/10 |
| `office.ua_env`, `office.w_buf`, `bedroom.f_air` | 7/10 |
...
duidelijke wind-helling, te warm bij weinig wind, te koud bij veel wind. Slaapkamer (grootste
...
`tools/twin2_residual_diagnostics.py --ventilation --room bedroom` — netwerk-verselucht vs. de
...
`solve_network`'s Newton-iteratie **oscilleerde**: de druk van bedroom sprong heen en weer
