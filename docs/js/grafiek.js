...
async function loadData() {
  ...
  // Deze pagina plot letterlijk de meetreeks per kamer (temp × vocht, 48u terug) —
  // het scherpste aanwezigheidsspoor van alle dashboards. Zelfde poort als vent.js
  // en window.js (privacy-sweep aug 2026).
  if (!(CONFIG.githubToken && CONFIG.artefactGistId)) {
    document.getElementById("banner-slot").innerHTML =
      ...
      `om de kamerreeksen te zien.</div>`;
